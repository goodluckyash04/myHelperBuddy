...
ALLOWED_HOSTS = config("ALLOWED_HOSTS", default="localhost,127.0.0.1").split(",") if not DEBUG else ["localhost", "127.0.0.1"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.ledger_modals_context',
            ],
        },
    },
]
